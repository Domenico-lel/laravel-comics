...
<section class="bg-black">
    <div class="container py-5">
        <div class="row position-relative">
            ...
            <!-- ciclo che stampa le card nell array comics  -->
            @foreach($comics as $comic)
            <div class="col-2 ">
                <img class="img-cartoon" src="{{ Vite::asset('resources/imgs/spiderman.jpg') }}" alt="immagine">
            ...
            <!-- bottone per caricare ulteriori card -->
